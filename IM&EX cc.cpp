    ...
    //Menu general
        ...
        switch (op){
            ...
            case 2:// Reportes / consultas
                ...
                break;
            case 3://Estadisticas
                //1. Dependencia que realiz贸 el mayor n煤mero de llamadas local, celular e internacional y el monto a pagar en cada caso.
                if(min_lo1>min_rh1 && min_lo1>min_finan1 ){//evaluamos cual de las locales es mayor
                    cout <<"\n\nLa dependencia de logistica realizo mayor n煤mero de llamadas locales con " << min_lo1 <<" \npara un monto total a pagar de $"<<min_lo1*80 <<endl;
                }
                else if(min_rh1>min_lo1 && min_rh1>min_finan1){
                    cout <<"\n\nLa dependencia de recursos humanos realizo mayor n煤mero de llamadas locales con " << min_rh1 <<" \npara un monto total a pagar de $"<<min_rh1*80 <<endl;
                ...
                if(min_lo2>min_rh1 && min_lo2>min_finan2 ){//evaluamos cual de las celulares es mayor
                    ...
                    cout <<"\n\nLa dependencia de recursos humanos realizo mayor n鷐ero de llamadas celulares con " << min_rh2 <<" \npara un monto total a pagar de $"<<min_rh2*800 <<endl;
                } 
                else if(min_finan2>min_lo2 && min_finan2>min_rh2){
                    cout <<"\n\nLa dependencia de finanzas realizo mayor n鷐ero de llamadas celulares con " << min_finan2 <<" \npara un monto total a pagar de $"<<min_finan2*800 <<endl;
                }

                if(min_lo3>min_rh3 && min_lo3>min_finan3 ){//evaluamos cual de las internacionales es mayor
                    cout <<"\n\nLa dependencia de logistica realizo mayor n鷐ero de llamadas internacionales con " << min_lo3 <<" \npara un monto total a pagar de $"<<min_lo3*1500 <<endl;
                }
                else if(min_rh3>min_lo3 && min_rh3>min_finan3){
                    cout <<"\n\nLa dependencia de recursos humanos realizo mayor n鷐ero de llamadas internacionales con " << min_rh3 <<" \npara un monto total a pagar de $"<<min_rh3*1500 <<endl;
                } 
                else if(min_finan3>min_lo3 && min_finan3>min_rh3){
                    cout <<"\n\nLa dependencia de finanzas realizo mayor n鷐ero de llamadas internacionales con " << min_finan3 <<" \npara un monto total a pagar de $"<<min_finan3*1500 <<endl;
                }

                //2. Llamada de mayor duraci贸n: indicar el funcionario(s), dependencia(s), tipo y tiempo duraci贸n 
                ...
                //4. Nombre del funcionario que realiz贸 el mayor n煤mero de llamadas, indicando a que oficina pertenece y la cantidad de llamadas que realiz贸
